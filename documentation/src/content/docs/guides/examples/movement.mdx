...
:::tip[Usage example]
Check out our tested [advanced movement example](https://github.com/Grigorij-Dudnik/RoboCrew/blob/e04698f42bea79fca9df252b5bf661183904a7a2/examples/1_xlerobot_advanced_movement.py) for a complete implementation of the concepts covered in this tutorial.
:::
