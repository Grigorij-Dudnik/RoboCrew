...
:::tip[Usage example]
Check out our tested [listening and speaking example](https://github.com/Grigorij-Dudnik/RoboCrew/blob/e04698f42bea79fca9df252b5bf661183904a7a2/examples/2_xlerobot_listening_and_speaking.py) for a complete implementation of the concepts covered in this tutorial.
:::
